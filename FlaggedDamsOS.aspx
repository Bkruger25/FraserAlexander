<%@ Page Title="" Language="VB" AutoEventWireup="false" CodeFile="FlaggedDamsOS.aspx.vb" Inherits="FlaggedDamsOS" %>
...
<div class="container body-content">
 ...
 <script>
     ...
     <div class="jumbotron">
         <h2 style="text-align: center">FLAGGED DAMS OPERATIONS STATUS</h2>
        ...
        <div class="row">
            ...
            <div id="MapViewer" runat="server" style="text-align:center">
                 <iframe visible="true" runat="server" id="mapframe" class="mapClass"  frameborder="0" scrolling="no" marginheight="0" marginwidth="0">
                </iframe>  
         </div> 
