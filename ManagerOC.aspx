<%@ Page Title="" Language="VB" AutoEventWireup="false" CodeFile="ManagerOC.aspx.vb" Inherits="ManagerOC" %>
...
<div class="container body-content">
    <div class="jumbotron">
         <h2 style="text-align: center">MANAGER OPERATIONS CATALOGUE</h2>
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <telerik:RadDropDownList DefaultMessage="Select an item" ID="RadDropDownList1" AutoPostBack="true" runat="server" DataSourceID="SqlDataSource1" Skin="Office2010Black">
                     ...
                     <telerik:RadButton ID="btnDamBookOfLife" style="line-height:23px;" height="23" Visible="false" runat="server" Text="Dam Book Of Life" Skin="Office2010Black" ></telerik:RadButton>   
                </div>
