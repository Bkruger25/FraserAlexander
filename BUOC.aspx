<%@ Page Title="" Language="VB"  AutoEventWireup="false" CodeFile="BUOC.aspx.vb" Inherits="BUOC" %>
...
<form runat="server">
 ...
 <div class="container body-content">
     <div class="jumbotron">
         <h2 style="text-align: center">PRODUCT TYPE OPERATIONS CATALOGUE</h2>
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <telerik:RadDropDownList Visible="false" DefaultMessage="Select an item" ID="RadDropDownList2" AutoPostBack="true" runat="server" DataSourceID="SqlDataSource2" Skin="Office2010Black">
                </telerik:RadDropDownList>
